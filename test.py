...
# Route pour récupérer un étudiant via son age
@app.route('/students/byage/<int:age>', methods=['GET'])
def get_student_byage(age):
    student = [student for student in students if student['age'] == age]
    return jsonify(student)
